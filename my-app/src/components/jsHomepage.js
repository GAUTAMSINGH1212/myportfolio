...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#003366] to-[#ffa500] min-h-screen p-6">
      {/* Main Header */}
      <h1 className="text-4xl font-extrabold text-center text-white py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {topics.map((topic) => (
          <div
            key={topic.id}
            className="  rounded-xl  hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:rotate-3 hover:translate-y-1"
          >
            <div className="bg-white p-4 rounded-lg shadow-lg border border-gray-200 group hover:bg-[#003366] hover:text-white transition-colors duration-300">
              <h2 className="text-xl font-semibold text-[#003366] group-hover:text-white mb-2">
                {topic.title} 📝
              </h2>
              <p className="text-gray-700 group-hover:text-white mb-2">{topic.description}</p>
              <Link
                to={`/topic${topic.link}`}
                className="text-blue-600 font-semibold group-hover:text-yellow-300 transition-colors duration-200"
              >
                👉 Read More
              </Link>
            </div>
      ...
      {/* About Section */}
      <section className="my-12 bg-white p-8 rounded-xl shadow-md">
        <h2 className="text-3xl font-bold text-center text-[#003366] mb-6">
          💡 About JavaScript Learning Hub
        </h2>
        <p className="text-lg text-gray-700">
          This platform is designed to help beginners and advanced developers enhance their JavaScript skills.
          Whether you're just starting or looking to master advanced topics, this is your go-to hub for resources, tutorials,
      ...
      <section className="my-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
            <h3 className="text-2xl font-semibold text-[#003366] mb-4">MDN Web Docs</h3>
            <p className="text-gray-700 mb-4">Comprehensive documentation on JavaScript and web development.</p>
            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" className="text-blue-600 hover:text-blue-800">Visit 🌐</a>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
            <h3 className="text-2xl font-semibold text-[#003366] mb-4">JavaScript.info</h3>
            <p className="text-gray-700 mb-4">A deep dive into JavaScript concepts, tutorials, and guides.</p>
            <a href="https://javascript.info/" className="text-blue-600 hover:text-blue-800">Visit 🔍</a>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
            <h3 className="text-2xl font-semibold text-[#003366] mb-4">Eloquent JavaScript</h3>
            <p className="text-gray-700 mb-4">A book that teaches JavaScript from basic to advanced topics.</p>
            <a href="https://eloquentjavascript.net/" className="text-blue-600 hover:text-blue-800">Visit 📖</a>
          </div>
        </div>
      </section>
